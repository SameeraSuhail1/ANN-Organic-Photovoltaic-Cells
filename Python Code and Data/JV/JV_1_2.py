...
xdftrain, ydftrain, xdftest, ydftest, xtrain, ytrain, xtest, ytest = split_tt(df_normed,70,102,'V','concentration')
...
for j in range(3,20):
    ...
    for i in range(n_ensemble-1):
        xdftrain, ydftrain,xdftest, ydftest, xtrain, ytrain, xtest, ytest,  = split_tt(df_normed,70,i+1,'V','concentration')
        #-------------seed------------------
        seed(i+1)
        set_random_seed(i+1)
        #-----------------------------------
