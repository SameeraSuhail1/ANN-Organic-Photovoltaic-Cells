...
def plot_true_vs_pred(ytest_unnormed, yhat_unnormed, ytrain_unnormed, ytrain_out_unnormed, exp_str, j):
...
#    ytrain_out_unnormed=make_unnorm(ytrain_out_df,norm_lims)
    ...
    plt.plot(ytest_unnormed, 'b', label='True Value') 
    ...
    plt.savefig(fname=exp_str + "/figures/test_learned_nh_" + str(j) + ".pdf")
    plt.show()
    
    #get_ipython().run_line_magic('matplotlib', 'qt')
    plt.plot(ytrain_unnormed, 'b', label='True Value') 
    ...
    plt.savefig(fname=exp_str + "/figures/train_learned_nh_" + str(j) + ".pdf")
    plt.show()
